...
def create_session(payload: dict, db: DbSession = Depends(get_db)) -> dict:
    ...
    s = Session(
        ...
        wall_clock_budget_s=int(payload.get("wall_clock_budget_s") or 600),
        token_cap_session=int(payload.get("token_cap_session") or 1_000_000),
        token_cap_iter=int(payload.get("token_cap_iter") or 100_000),
        max_files_per_diff=int(payload.get("max_files_per_diff") or 1),
        review_mode=review_mode,
        review_timeout_hours=int(payload.get("review_timeout_hours") or 48),
        worktree_prune_window=int(payload.get("worktree_prune_window") or 10),
        validation_retry_max=int(payload.get("validation_retry_max") or 3),
